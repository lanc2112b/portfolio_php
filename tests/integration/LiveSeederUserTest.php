...
class LiveSeederUserTest extends TestCase
{
    ...
    public function testTableHasColumns()
    {
        ...
        $this->assertEquals('photo_url', $columns[5]['Field']);
        $this->assertEquals('created_at', $columns[6]['Field']);
        $this->assertEquals('updated_at', $columns[7]['Field']);
        $this->assertEquals('deleted_at', $columns[8]['Field']);
        $this->assertEquals('refresh_at', $columns[9]['Field']);
        $this->assertEquals('access_token', $columns[10]['Field']);
    }
